<div class="card card-crm busqueda-item" id="busqueda" name="busqueda">
        {{ form('', 'id': 'indexprincipal','name': 'indexprincipal','','class':'form-vertical col-md-12 row') }}
                  ...
                  <div class="col-lg-3">
                    ...
                    <select name="eje_idprincipal" id="eje_idprincipal" class="form-control select2-multiple" data-toggle="select2" data-placeholder="Seleccionar ...">
                  ...
                  <div class="col-lg-3">
                    ...
                    <select name="exc_estatus" id="exc_estatus" data-toggle="select2" class="form-control select2-multiple">
                        <option value="-1">Todos</option>
                        {% for item in exc_estatus %}
                  ...
                  <div class="col-lg-4" >
                    ...
                    <input id="can_nombre" name="can_nombre" type="text" class="form-control input-rounded data-not-lt-active" maxlength="25" placeholder="Nombre candidato"  oninput="handleInput(event)"  />
                  </div>
                  <div class="col-lg-4" >
                    <label class="col-form-label title-busq">Primer apellido candidato</label>
                    <input id="can_primerapellido" name="can_primerapellido" type="text" class="form-control input-rounded data-not-lt-active" maxlength="19" placeholder="Primer apellido candidato"  oninput="handleInput(event)"  />
                  </div>
                  <div class="col-lg-4" >
                    <label class="col-form-label title-busq">Segundo apellido candidato</label>
                    <input id="can_segundoapellido" name="can_segundoapellido" type="text" class="form-control input-rounded data-not-lt-active" maxlength="25" placeholder="Segundo apellido candidato"  oninput="handleInput(event)"  />
                  </div>
                  ...
                  <div class="col-lg-4" >
                    ...
                    <input id="filtro_can_curp" name="can_curp" type="text" class="form-control input-rounded data-not-lt-active" maxlength="19" placeholder="CURP candidato"  oninput="handleInput(event)"  />
                  </div>
                  <div class="col-lg-4" >
                    <label class="col-form-label title-busq">Nombre de vacante</label>
                    <input id="filtro_cav_nombre" name="cav_nombre" type="text" class="form-control input-rounded" maxlength="25" placeholder="Nombre de vacante"  oninput="handleInput(event)"  />
                  </div>
                            ...
                            <div>
                                <div class="input-group" id="">
                                  <label class="col-form-label  title-busq">Desde</label>
                                    <input type="date" id="exc_registro_fechainicial" name="exc_registro_fechainicial" class="form-control bar-left" placeholder="Desde" />
                                    <label class="col-form-label  title-busq">Hasta</label>
                                    <input type="date" id="exc_registro_fechafinal" name="exc_registro_fechafinal" class="form-control bar-right" placeholder="Hasta" />
                                </div>
                  ...
                  <div class="col-lg-6 d-none" id="fecha_entrega_cliente_div" >
                        ...
                        <label class="col-form-label  title-busq">Fecha entrega cliente <i class="mdi mdi-account-multiple-minus-outline"></i></label>
                            <div>
                                <div class="input-group" id="">
                                  <label class="col-form-label  title-busq">Desde</label>
                                    <input type="date" id="exc_fechaentregacliente_f_inicial" name="exc_fechaentregacliente_f_inicial" class="form-control bar-left" placeholder="Desde" />
                                    <label class="col-form-label  title-busq">Hasta</label>
                                    <input type="date" id="exc_fechaentregacliente_f_final" name="exc_fechaentregacliente_f_final" class="form-control bar-right" placeholder="Hasta" />
                                </div>
                  ...
                  <div class="col-lg-6 d-none" id="fecha_asig_ana_div" >
                        ...
                        <label class="col-form-label  title-busq">Fecha analista<i class="mdi mdi-account-multiple-minus-outline"></i></label>
                            <div>
                                <div class="input-group" id="">
                                  <label class="col-form-label  title-busq">Desde</label>
                                    <input type="date" id="exc_fechaasiganalista_f_inical" name="exc_fechaasiganalista_f_inical" class="form-control bar-left" placeholder="Desde" />
                                    <label class="col-form-label  title-busq">Hasta</label>
                                    <input type="date" id="exc_fechaasiganalista_f_final" name="exc_fechaasiganalista_f_final" class="form-control bar-right" placeholder="Hasta" />
                                </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6 d-none" id="fecha_entrega_ana_div" >
                        ...
                        <label class="col-form-label  title-busq">Fecha entrega ejecutivo</label>
                            <div>
                                <div class="input-group" id="">
                                  <label class="col-form-label  title-busq">Desde</label>
                                    <input type="date" id="exc_fechaentregaanalista_f_inicial" name="exc_fechaentregaanalista_f_inicial" class="form-control bar-left" placeholder="Desde" />
                                    <label class="col-form-label  title-busq">Hasta</label>
                                    <input type="date" id="exc_fechaentregaanalista_f_final" name="exc_fechaentregaanalista_f_final" class="form-control bar-right" placeholder="Hasta" />
                                </div>
                  ...
                  <div class="col-lg-6 d-none" id="fecha_asig_inv_div" >
                        ...
                        <label class="col-form-label  title-busq">Fecha de asignación investigador</label>
                            <div>
                                <div class="input-group" id="">
                                  <label class="col-form-label  title-busq">Desde</label>
                                    <input type="date" id="exc_fechaasiginvestigador_f_inical" name="exc_fechaasiginvestigador_f_inical" class="form-control bar-left" placeholder="Desde" />
                                    <label class="col-form-label  title-busq">Hasta</label>
                                    <input type="date" id="exc_fechaasiginvestigador_f_final" name="exc_fechaasiginvestigador_f_final" class="form-control bar-right" placeholder="Hasta" />
                                </div>
                  ...
                  <div class="col-lg-5  d-none" id="trasnporte_asig_div">
                    ...
                    <select name="exc_transporte" id="exc_transporte" data-toggle="select2" class="form-control select2-multiple">
                        <option value="-1">Todos</option>
                  ...
                  <div class="col-lg-3 d-none" id="filtro_vac_id_div">
                    <label class="col-form-label title-busq">Vacante ID<i class="mdi mdi-share-variant"></i></label>
                        <input pattern="\d+" type="number" id="vac_id" name="filtro_vac_id" class="form-control input-rounded data-not-lt-active" placeholder="ID VACANTE" oninput="validarNumero(this)" />
                  ...
                  <div class="col-lg-5  d-none" id="filtro_sel_necesitoauxiliar_div">
                      ...
                      <select name="sel_necesitoauxiliar" id="sel_necesitoauxiliar" data-toggle="select2" class="form-control select2-multiple">
                        <option value="-1">Todos</option>
                        <option value="1">SÍ</option>
                  ...
                  <div class="col-lg-5  d-none" id="filtro_sel_empleosocultos_div">
                      ...
                      <select name="sel_empleosocultos" id="sel_empleosocultos" data-toggle="select2" class="form-control select2-multiple">
                        <option value="-1">Todos</option>
                        <option value="1">SÍ</option>
                        <option value="0">NO</option>
                      </select>
