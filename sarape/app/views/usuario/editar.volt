<script type="text/javascript">
  function cambiarestados() {
    ...
    pais=document.getElementById("pai_id").value;
        url="<?php echo $this->url->get('estado/lista/') ?>";
        url=url+pais;
  ...
  function cambiarsubunidad() {
    // alert(id);
    divListado = document.getElementById('subunidad');
          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                <div>
                  {{ form('usuario/editar/', 'id': 'usuario_editar', 'class': 'captura form-horizontal form-label-left','data-parsley-validate') }}
                            ...
                            <div>
                              <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                  {{ form.label('usu_id') }}
                                  {{ form.render('usu_id', ['class': 'form-control','required': 'true','placeholder':'0000000','readonly':'true']) }}
                                </div>
                              </div>
                               <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                  {{ form.label('usu_password') }}
                                  {{ form.render('usu_password', ['class': 'form-control','required': 'true','placeholder':'●●●●●●●','disabled':'true','readonly':'true']) }}
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                              {{ form.label('sde_id') }}
                              <div id='subunidad'>
                                {{ form.render('sde_id', ['class': 'form-control','placeholder':'Sub-unidad de venta']) }}
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="row ">
                        <div class="col-sm-6 col-xs-12">
                          <div class="form-group">
                            ...
                            <input name="usu_nocuenta" type="number" class="form-control" id="usu_nocuenta" placeholder="(10 dígitos)" required> -->
                          </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                          <div class="form-group">
