...
{% set treintaynueveEditar= acceso.verificar(39,rol_id) %}
{# datos por rh #}
{% set cuarentaEditar= acceso.verificar(40,rol_id) %}
{# escala desempeño #}
    ...
    )
  {
    ...
    $.ajax({
      ...
      success: function(data)
      {
        ...
        $('#rel_sel_id_editar').text(data.sel_id);
        ...
        $('#rel_calidad_editar').select2({
              dropdownParent: $('#editar-referencialaboral-modal')
          });
        ...
        $('#rel_responsabilidad_editar').trigger('change');
          ...
          $('#rel_responsabilidad_editar').select2({
              dropdownParent: $('#editar-referencialaboral-modal')
          });
          $('#rel_adicciones_editar').select2({
              dropdownParent: $('#editar-referencialaboral-modal')
          });
          $('#rel_iniciativa_editar').select2({
              dropdownParent: $('#editar-referencialaboral-modal')
          });

          $('#rel_puntualidad_editar').select2({
              dropdownParent: $('#editar-referencialaboral-modal')
          });
...
<div class="modal fade" id="editar-referencialaboral-modal" tabindex="9999" style="z-index:99999;" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
 ...
 -->        <div class="modal-header">
            <h5><div id="">
              <i class="mdi mdi-pencil-circle"></i>Editar una referencia laboral  de la sección laboral No. <span id="rel_sel_id_editar"></span> 
            </div></h5>
          ...
          <div class="modal-body">
            ...
            <form id="frm_editar_referencialaboral" class="form-vertical mt-1" novalidate method="post">
              <div class="form-group row">
                ...
                <div class="{% if cuarentaEditar==1 %} col-lg-6{% else %} col-lg-12{% endif %} ">
                ...
                <div class="col-lg-6">
                  ...
                  <input name="rel_candidatojefe_editar" id="rel_candidatojefe_editar" type="text" class="form-control input-rounded data-not-lt-active" oninput="handleInput(event)"   placeholder="Nombre de jefe inmediato..."  maxlength="50"/>
                </div>

                {% if cuarentaEditar==1 %}
                <div class="col-lg-6">
                  <label class="col-form-label title-busq">Nombre de jefe inmediato -RH</label>
                  <input name="rel_rhjefe_editar" id="rel_rhjefe_editar" type="text" class="form-control input-rounded data-not-lt-active" oninput="handleInput(event)"   placeholder="Nombre de jefe inmediato..."  maxlength="50"/>
                </div>
                {% endif %}              
