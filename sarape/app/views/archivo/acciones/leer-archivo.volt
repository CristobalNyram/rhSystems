<script type="text/javascript">
	function leerarchivo(id,nombre_archivo,tipo,exc_id){
      let url = "<?php echo $this->url->get('archivo/ajax_getImagen/') ?>";
      const archivoURL = "<?php echo $this->url->get() ?>" + tipo + '/' + exc_id + '/' + encodeURIComponent(nombre_archivo);
      const mensajeError = `
...
<div class="modal fade" id="leerarchivo-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; z-index: 999999;">
