<script type="text/javascript">
  function principal(){
    ...
    if(validacion)
    {
      ...
      urlreloadprincipal="<?php echo $this->url->get('reporte/facturacion_tabla/') ?>";
...
<div class="row">
  <div class="col-6">
    <h4 class="header-title header-title-crm">Facturación</h4>
  </div>
  <div class="col-6">
    ...
    <div id="busqueda" name="busqueda">
      ...
      <form id="form_estatus_estudio"  class="form-vertical col-md-12 row">
        ...
        <div class="col-lg-1 col-3  text-right">
          <div class="form-group">
            {{ link_to('reporte/facturacion_index', '<i class="mdi mdi-eraser white" title="Limpiar búsqueda"></i>',"class": "btn-dark btn-rounded btn btn-limpiar") }}
          </div>
        </div>  
      </form>
      {% endif %}
