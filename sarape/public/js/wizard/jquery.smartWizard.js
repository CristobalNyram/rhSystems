...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-btnempresa"),
        next : $('<a id="next_button">'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-btnempresa"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-btnempresa submit"),
    };
