        ...
        if($this->request->isAjax())
        {
            ...
            if($existe==true){
                ...
                if($registro->save())
                {
                    ...
                    $databit['bit_descripcion']= "Creó un municipio con folio interno: ".$registro->mun_id;
                    $databit['usu_id']=$auth['id'];
                    $databit['bit_tablaid']=0;
                    $databit['bit_modulo']="Municipio";
        ...
        if($this->request->isAjax()&&$clave>0)
        {
            ...
            if($registro)
            {
                ...
                if($registro->save())
                {
                    ...
                    $auth = $this->session->get('auth');
                    $bitacora= new Bitacora();
                    $databit['bit_descripcion']= "Editó el municipio clave ".$data["mun_claveeditar"].', folio interno: '.$clave;
                    $databit['usu_id']=$auth['id'];
