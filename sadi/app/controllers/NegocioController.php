    ...
    public function nuevoAction()
    {
        ...
        if($this->request->isAjax())
        {
            ...
            if($negocio->save())
            {
                ...
                $databit['bit_descripcion']= 'Creó un grupo de negocio: '.$data['neg_nombre'];
                $databit['usu_id']=$auth['id'];
                $databit['bit_tablaid']=$negocio->neg_id;
                $databit['bit_modulo']="Negocio";
        ...
        if($this->request->isAjax()&&$clave>0)
        {
            ...
            if($negocio)
            {
                ...
                if($negocio->save())
                {
                    $auth = $this->session->get('auth');
                    $bitacora= new Bitacora();
                    $databit['bit_descripcion']= "Editó el negocio con id interno: ".$data["neg_ideditar"].',con nombre '.$negocio->neg_nombre;
                    $databit['usu_id']=$auth['id'];
    ...
    public function eliminarAction($neg_id=0)
    {
        ...
        {  
            ...
            $negocio->neg_estatus=-1;    
                ...
                {
                    $bitacora= new Bitacora();
                    $databit['bit_descripcion']= 'Eliminó el grupo de negocio con ID interno: '. $negocio->neg_id;
                    $databit['usu_id']=$auth['id'];
                    $databit['bit_tablaid']=$negocio->neg_id;
                    $databit['bit_modulo']="Negocio";
                    $bitacora->NuevoRegistro($databit);
