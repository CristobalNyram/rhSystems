...
class PdfReporteGabineteTubos extends Component
{
        ...
        <table style="font-family:Montserrat,sans-serif;  width:100%; font-weight:bold" class="tableDatos">
            <tbody>
                <tr>
                    ...
                    AVISO: #ese_nombre# y titular de los datos personales incluidos en este reporte de estudio socio laboral ha firmado un aviso de privacidad con Soluciones Ideales en Personal Seleccionado S.A. de C.V. (SIPS) y también ha autorizado compartir su información con TUBOS DE ACERO DE MÉXICO S.A., por lo que SIPS no tiene ninguna responsabilidad civil, penal o mercantil respecto al uso que TUBOS DE ACERO DE MÉXICO S.A., pueda hacer con la información.
                    </td>
                </tr>
            </tbody>
        </table>
