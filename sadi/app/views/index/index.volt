...
<head>
  ...
  <script src='https://www.google.com/recaptcha/api.js?render=6LfRM7EpAAAAANN4TAFMRjJ6a8YDyG9rR7C52oLT'></script>
  <script>
    let repeticion =  window.setInterval("verificaptcha()", 110000);

    function verificaptcha(){
      grecaptcha.ready(function() {
      grecaptcha.execute('6LfRM7EpAAAAANN4TAFMRjJ6a8YDyG9rR7C52oLT', {action: 'ejemplo'})
        .then(function(token) {
...
<body>
  ...
  <div class="row">
    <div class="col-md-12 col-lg-12 login-back colspan">
      ...
      <div class="col-md-6 col-lg-6 logo-crm">
        <h1>Sistema de Administración de Investigaciones</h1>
      </div>
    </div>
