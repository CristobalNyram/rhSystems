<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    url="<?php echo $this->url->get('estudio/asignarinvestigador_tabla/') ?>";
  ...
  <div class="row">
    <div class="col-sm-6">
      <h4 class="header-title header-title-crm">Asignar investigador</h4>
    </div>
    <div class="col-sm-5">    
    </div>
    <div class="col-sm-1">
...
{% include "/estudio/asignarinvestigador-modal-js.volt" %}
