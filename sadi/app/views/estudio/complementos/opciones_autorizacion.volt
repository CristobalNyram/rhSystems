<a data-toggle="modal" type="button" title="Autorizar" class="" data-container="body" data-toggle="popover" role="button" data-target="#autorizar-modal" onclick="fnautorizarESE('{{ esc.ese_id }}','{{ esc.tip_id }}')">
    <i class="mdi mdi-send-check mdi-18px btn-icon"></i>
</a>
<a data-toggle="modal" type="button" title="No aprobada" class="" data-container="body" data-toggle="popover" role="button" data-target="#noaprobar-modal" onclick="fnnoaprobarESE('{{ esc.ese_id }}')">
    <i class="mdi mdi-close-box-outline mdi-18px btn-icon"></i>
</a>
{% if dieciseis==1 %}
...
{% if treintaycuatro==1 %}
    ...
    {% endif %}
    <a data-toggle="modal" title="Regresar a estatus anterior." type="button" class="" data-container="body" data-toggle="popover" role="button" data-target="#regresar_estatus-modal" onclick="fn_llenar_regresar_estatus_Modal('{{esc.ese_id}}','{{NombreEstatus}}')">
