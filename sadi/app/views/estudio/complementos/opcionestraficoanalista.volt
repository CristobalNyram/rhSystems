...
{% else %}
<a data-toggle="modal" type="button" title="Enviar para autorización" class="" data-container="body" data-toggle="popover" role="button"  data-target="#enviaraautorizacion-modal" onclick="fnenviaraautorizacionESE('{{ esc.ese_id }}')" >
...
{% if once==1 %}
    ...
    <a data-toggle="modal"   type="button" title="Re-asignar analista" class="" data-container="body" data-toggle="popover" role="button"  data-target="#re_asignar_analista_en_trafico-modal" onclick="fnReAsignarAnalistaEnTrafico('{{ esc.ese_id }}','{{ esc.ana_id}}',1)" >
