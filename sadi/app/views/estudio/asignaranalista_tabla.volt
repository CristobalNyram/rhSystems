{% include "/estudio/complementos/permisos/permisos_asignar_analista.volt" %}
    ...
    <table id="td_empresa" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="uppercase" data-order='{{ date("Y-m-d H:i:s",strtotime(esc.ese_fechaentregainvestigador)) }}'>{{ date("d-m-Y", strtotime(esc.ese_fechaentregainvestigador)) }}</td>
                ...
                <td width="7%">
                    {% include "/estudio/complementos/opciones_asignaranalista.volt" %}
