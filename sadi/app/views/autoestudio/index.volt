...
<head>
    {% include "/autoestudio/layouts/head_login.volt" %}
...
<body>
  ...
  <div class="row">
      <div class="col-md-12 col-lg-12 login-aes-back colspan">
      ...
      <div class="col-md-4 col-sm-4 offset-md-4">
            <div class="account-pages pt-4">
                      ...
                      <p>Para iniciar, ingresa tus datos.</p>
                                ...
                                <form method='post' id='formSession_autoeses' class="p-2">
  ...
  {% include "/autoestudio/eses_login_js.volt" %}
