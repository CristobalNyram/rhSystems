<script>
    function fngetDataTipoAuto_FormatoTruper(auto_tipo_id=0,select_input=0){
             let url_enviar="<?php echo $this->url->get('automovil/ajax_get_data_tipo_auto_formatotruper/') ?>";
