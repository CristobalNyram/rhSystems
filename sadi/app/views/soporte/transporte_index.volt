<script type="text/javascript">
  function principal(){
      ...
      urlreloadprincipal="<?php echo $this->url->get('soporte/transporte_tabla/') ?>";
...
<div class="row">
  <div class="col-6">
          <h4 class="header-title header-title-crm">Transporte</h4>
  </div>
  <div class="col-6">
    ...
    <div id="busqueda" name="busqueda">
        <form id="form_estatus_estudio"  class="form-vertical col-md-12 row">
          ...
          <div class="col-lg-1 col-3  text-right mt-4">
            <div class="form-group">
              {{ link_to('soporte/transporte_index', '<i class="mdi mdi-eraser white" title="Limpiar búsqueda"></i>',"class": "btn-dark btn-rounded btn btn-limpiar") }}
            </div>
          </div>
        </form>
    </div>
...
{% include "/transporte/asignarautorizado-transporte.volt" %}