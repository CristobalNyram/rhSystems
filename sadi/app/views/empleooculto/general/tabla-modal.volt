...
<script>
    function CargarTablaDatoEmpleosOcultos(id=0)
    {             
                 ...
                 url="<?php echo $this->url->get('empleooculto/tabla/') ?>";
                  url+=id;
                    ...
                    $.post(url, $(this).serialize() , function(data)
                    {
                        ...
                        $('#dato_empleo_oculto_general_listado').empty();
                        $('#dato_empleo_oculto_general_listado').html(data);
  
                            $('#dato_empleo_oculto_general_table').DataTable(
                                  {
                                                "pageLength": 100,
                                                order:[0,'asc'],
