    ...
    $.ajax(
    {
      ...
      success: function(res)
      {
        ...
        else
        {
            ...
            //$("#usu_est_id_alta").val(res[1].est_id).change();
            fnestados_estados_adaptable(res[1].est_id,$('#usu_est_ideditar'));
            fnmunicipios_adaptable($('#usu_mun_ideditar'),res[1].est_id,res[1].mun_id,"Selecciona un estado");
          ...
          <form id="frm_editarusuario" class="form-vertical mt-1">
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                ...
                <input id="usu_nombreeditar" name="usu_nombreeditar" type="text" maxlength="45" class="form-control input-rounded data-not-lt-active" minlength="2" placeholder="Nombre(s)" required oninput="handleInput(event)"/>
              </div>
              ...
              <div class="col-lg-4">
                ...
                <input id="usu_adicionaleditar" name="usu_adicional" type="text" class="form-control input-rounded" placeholder="Contacto adicional" maxlength="155"/>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <select name="est_id" id="usu_est_ideditar" class="form-control select2-single " data-toggle="select2" data-placeholder="Seleccionar ..." onchange='fnmunicipios_adaptable($("#usu_mun_ideditar"),$("#usu_est_ideditar").val(),-1,"Selecciona un estado")'>
                  <option selected value="-1">Seleccione un estado</option>
                </select>
              </div>
              <div class="col-lg-6">
                <label class="col-form-label title-busq">Municipio</label>
                <select name="mun_id" id="usu_mun_ideditar" class="form-control select2-single " data-toggle="select2" data-placeholder="Seleccionar ...">
                  <option selected value="-1">Seleccione un estado</option>
                </select>
              </div>
