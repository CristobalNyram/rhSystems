<script type="text/javascript">
  ...
  {
    var urlfned="<?php echo $this->url->get('contactoemp/buseditar/') ?>";
    $("#msae").html("Editar "+nombre); 
    $.ajax(
    {
        type: "POST",
  ...
  function fngruponegocio()
  {
    ...
    $(document).ready(function() {
      ...
      $('#contactonuevo-modal').on('shown.bs.modal', function() {
          // Resetear el formulario
          $('#frm_crearcontacto').trigger('reset');
        });
...
<div class="row">
  ...
  <div class="col-sm-1">
  <div class="text-left">
    {{ link_to('', 'data-target':'#Modal_empresa', "onclick":"fngruponegocio(); getTodosTipoFormatoActivo('emp_tipoformato');", 'data-toggle':'modal', image("assets/images/small/boton.svg", 'class':'boton-plus', 'height':'60'))  }}
      ...
      <div class="modal-body">
        {{ form('empresa/cambiarfoto', 'method': 'post', 'enctype': 'multipart/form-data','class' : 'form-vertical mt-1') }}
          ...
          <div class="form-group row">
            <div class="col-lg-12">
              <label class="col-form-label title-busq">Firma nueva</label>
        ...
        <form id="frm_crearcontacto" class="form-vertical mt-1">
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              ...
              <input id="cne_nombre" name="cne_nombre" maxlength="45" type="text" class="form-control input-rounded" minlength="2" placeholder="Nombre(s)" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Primer apellido</label>
              <input id="cne_primerapellido" name="cne_primerapellido" maxlength="45" type="text" class="form-control input-rounded" placeholder="Primer apellido" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Segundo apellido</label>
              <input id="cne_segundoapellido" name="cne_segundoapellido"  maxlength="45" type="text" class="form-control input-rounded" placeholder="Segundo apellido" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Puesto</label>
              <input id="cne_puesto" name="cne_puesto" type="text" class="form-control input-rounded" maxlength="45" placeholder="Puesto" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Celular</label>
              <input id="cne_celular" name="cne_celular" type="text" class="form-control input-rounded" maxlength="45" placeholder="Celular" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Teléfono</label>
              <input id="cne_tel" name="cne_tel" type="text" class="form-control input-rounded"  maxlength="45" placeholder="Teléfono" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Extensión</label>
              <input id="cne_ext" name="cne_ext" type="text" class="form-control input-rounded" maxlength="45" placeholder="Extensión"  oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Correo</label>
              <input id="cne_correo" name="cne_correo" type="email" class="form-control input-rounded" placeholder="Correo"  maxlength="90"/>
            </div>
            <div class="col-lg-9">
      ...
      <div class="modal-body">
        <form id="frm_editarcontacto" class="form-vertical mt-1">
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Nombre(s)</label>
              <input id="cne_nombreeditar" name="cne_nombreeditar" type="text" maxlength="45" class="form-control input-rounded" minlength="2" placeholder="Nombre(s)" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Primer apellido</label>
              <input id="cne_primerapellidoeditar" name="cne_primerapellidoeditar"  maxlength="45" type="text" class="form-control input-rounded" placeholder="Primer apellido" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Segundo apellido</label>
              <input id="cne_segundoapellidoeditar" name="cne_segundoapellidoeditar"  maxlength="45" type="text" class="form-control input-rounded" placeholder="Segundo apellido" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Puesto</label>
              <input id="cne_puestoeditar" name="cne_puestoeditar" type="text"  maxlength="45" class="form-control input-rounded" placeholder="Puesto" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Celular</label>
              <input id="cne_celulareditar" name="cne_celulareditar" type="text"  maxlength="20" class="form-control input-rounded" placeholder="Celular" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Teléfono</label>
              <input id="cne_teleditar" name="cne_teleditar" type="text"  maxlength="20" class="form-control input-rounded" placeholder="Teléfono" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Extensión</label>
              <input id="cne_exteditar" name="cne_exteditar" type="text"  maxlength="20" class="form-control input-rounded" placeholder="Extensión"  oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Correo</label>
              <input id="cne_correoeditar" name="cne_correoeditar" type="email" class="form-control input-rounded" placeholder="Correo"   maxlength="90"/>
            </div>
            <div class="col-lg-9">
              <label class="col-form-label title-busq">Correos para enviar copias (separar por punto y coma ";")</label>
              <input id="cne_copiaenvioeditar" name="cne_copiaenvioeditar"  maxlength="300" type="text" class="form-control input-rounded" placeholder="Copias para envío de correo"   />
            </div>
            <div class="row col-lg-12">
              <div class="col-sm-6 col-md-6 text-center mt-5">
              </div>
        ...
        <form id="frm_crearcentro" class="form-vertical mt-1">
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              ...
              <input id="cen_clave" name="cen_clave" type="text" class="form-control input-rounded" placeholder="Clave" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Nombre</label>
              <input id="cen_nombre" name="cen_nombre" type="text" class="form-control input-rounded" placeholder="Nombre" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Teléfono</label>
              <input id="cen_tel" name="cen_tel" type="text" class="form-control input-rounded" placeholder="Teléfono" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Correo</label>
              <input id="cen_correo" name="cen_correo" type="email" class="form-control input-rounded" placeholder="Correo" />
            </div>
            <div class="row col-lg-12">
              <div class="col-sm-6 col-md-6 text-center mt-5">
              </div>
      ...
      <div class="modal-body">
        <form id="frm_editarcentro" class="form-vertical mt-1">
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Clave</label>
              <input id="cen_claveeditar" name="cen_claveeditar" type="text" maxlength="45" class="form-control input-rounded" placeholder="Clave" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-4">
              <label class="col-form-label title-busq">Nombre</label>
              <input id="cen_nombreeditar" name="cen_nombreeditar" type="text" minlength="2" maxlength="255" class="form-control input-rounded" placeholder="Nombre" required oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Teléfono</label>
              <input id="cen_teleditar" name="cen_teleditar" type="text"  maxlength="45" class="form-control input-rounded" placeholder="Teléfono" oninput="handleInput(event)"/>
            </div>
            <div class="col-lg-3">
              <label class="col-form-label title-busq">Correo</label>
              <input id="cen_correoeditar" name="cen_correoeditar" type="email" maxlength="45" class="form-control input-rounded" placeholder="Correo"/>
            </div>
            <div class="row col-lg-12">
              <div class="col-sm-6 col-md-6 text-center mt-5">
              </div>
...
{% include "/tipoformato/script-ajax-get-todos.volt" %}
{% include "/empresaformato/tabla-modal.volt" %}
