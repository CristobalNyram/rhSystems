{% for esc in estudio %}
	...
	{% endif %}
					<tr>
						...
						<td class="uppercase" data-order='{{ date("Y-m-d H:i:s",strtotime(esc.ese_fechaentregacliente)) }}'>{{ date("d-m-Y", strtotime(esc.ese_fechaentregacliente)) }}</td>
						...
						<td>
        					...
        					{% include "cliente/complementos/historial_opciones.volt" %}
						</td>
