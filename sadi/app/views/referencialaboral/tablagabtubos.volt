...
{% set total_rel = page|length %}
    ...
    {% if loop.first %}
		<div class="table-responsive m-3" id="lista-agrupada" style="padding-right: 20px; padding-left: 20px;">
		    <table id="dato_referencialaboral_table_gabtubos" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		        ...
		        {% endif %}
		            <tr>
						...
						<td>
							...
							<a data-toggle="modal" title="Editar" type="button" class="" data-container="body" data-toggle="popover" role="button" data-target="#editar-referencialaboral_formato_gabtubos-modal" onclick="fnEditarReferenciaLaboral_formato_gabtubos(
							...
							<a title="Eliminar" type="button" class="" data-container="body" data-toggle="popover" role="button" onclick="fnElimnaReferenciaLaboral_formato_gabtubos('{{ rel.rel_id }}')">
							...
							{% if noventa==1 %}
								...
								{% set btn_abajo_display = rel_orden == total_rel ? 'none' : 'inline-block' %}
									<a data-toggle="modal" 
									title="Cambiar orden arriba" 
									type="button" class="" 
									data-container="body" 
									data-toggle="popover" 
									role="button"  
									onclick="fnArribaOrdenCambiar('{{rel.rel_id}}',fnCargarTablaDatoReferenciaLaboral_formato_gabtubos)" 
									...
									<a 
									data-toggle="modal" 
									title="Cambiar orden abajo" 
									type="button" class="" 
									data-container="body" 
									data-toggle="popover" 
									role="button"  
									onclick="fnAbajoOrdenCambiar('{{rel.rel_id}}',fnCargarTablaDatoReferenciaLaboral_formato_gabtubos)"
