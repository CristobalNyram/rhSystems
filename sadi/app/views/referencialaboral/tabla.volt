		        ...
		        {% endif %}
		            <tr>
						...
						<td>
							...
							<a title="Eliminar" type="button" class="" data-container="body" data-toggle="popover" role="button" onclick="fnElimnaReferenciaLaboral('{{ rel.rel_id }}')">
							...
							{% if noventa==1 %}
									...
									<a 
									data-toggle="modal" 
									title="Cambiar orden arriba" type="button" class="" 
									data-container="body" data-toggle="popover" role="button"  
									onclick="fnArribaOrdenCambiar('{{rel.rel_id}}',fnRe_CargarTablaDatoReferenciaLaboral)" 
									style="display: {{ btn_arriba_display }};">
										<i class="mdi mdi-arrow-up-bold mdi-18px btn-icon"></i>
									</a>	
									{% if rel_orden != total_rel %}
									<a data-toggle="modal" 
									title="Cambiar orden abajo" type="button" class="" 
									data-container="body" data-toggle="popover" role="button"  
									onclick="fnAbajoOrdenCambiar('{{rel.rel_id}}',fnRe_CargarTablaDatoReferenciaLaboral)"  
