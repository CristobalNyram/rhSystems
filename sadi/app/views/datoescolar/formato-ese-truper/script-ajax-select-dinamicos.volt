<script>
    ...
    function fngetDataSelectsDinamicosDatosDocumentosRecibidos(
                 ...
                 let url_enviar="<?php echo $this->url->get('datoescolar/ajax_get_data_selects_documentorecibidos/') ?>";
                ...
                {
                    let data=Object.entries(res['docrecibidos_data']);
