...
<div class="modal fade" id="agregar-referenciavecinal-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            ...
            <form id="frm_crear_referenciavecinal" class="form-vertical mt-1" novalidate method="post">
              <div class="form-group row">
                ...
                <div class="col-lg-12">
                  ...
                  <input name="rev_nombre_crear" id="rev_nombre_crear data-not-lt-active" type="text" class="form-control input-rounded" required oninput="handleInput(event)"  placeholder="Nombre completo..." maxlength="55" />
