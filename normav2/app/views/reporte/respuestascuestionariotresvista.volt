...
$(document).ready(function(){
  ...
  var url_descarga="<?php echo $this->url->get('reporte/respuestascuestionariotres/') ?>";

  $("#from_reporte_calificacion_cuestionario_3").submit(function(event) 
      {
        event.preventDefault();
  var urlEnviar="<?php echo $this->url->get('reporte/manejadorconsultacuestionario3/') ?>";
         $.ajax(
           {
                url:urlEnviar,
                type:"POST",
                data:$("#from_reporte_calificacion_cuestionario_3").serialize(),
               ...
               <div class="text-center col-md-12 ">
                           <div class="mt-1">
                                      <span class="font-16 btn-link-crm">
                                        Reporte de las calificaciones de los cuestionarios 3 de la NOM-35
                                      </span>
                           </div>
                 </div>
                      <hr class="line-down">
                      
                <form class="container" method="post" enctype="multipart/form-data" id="from_reporte_calificacion_cuestionario_3">
                      <div class="row">
