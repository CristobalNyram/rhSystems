...
<script type="text/javascript">
	function validarfolio(){
      ...
      urlfolio="<?php echo $this->url->get('cuestionariodos/revisarfolio/') ?>";
			...
			success: function(res)
			{
			  ...
			  else
			  {
			    ...
			    alertify.alert("Éxito","Datos guardados correctamente.", function(){ 
					...
					{
			          	document.getElementById("cuestionariodos").reset();
                ...
                <div>
                	<form id="cuestionariodos" name="cuestionariodos"  class="data-parsley-validate"  onsubmit="return false;">
                		<div id="seccion1" class="cardcuestionario">
		            		...
		            		<h3 class="suntitulo">Para responder las preguntas siguientes considere las condiciones de su centro de trabajo, así como la cantidad y ritmo de trabajo.</h3>
		            		<br>
		            		<table>
            					<tr>
									<td>
									...
									<br>
										<div class="group">
											...
											<label><input type="radio" name="1" value="4" required>Siempre</label> <br>
        						...
        						<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="4" value="4" required >Siempre </label><br>
						...
						<div id="seccion3" class="cardcuestionario">
							<h3 class="suntitulo">Las preguntas siguientes están relacionadas con el tiempo destinado a su trabajo y sus responsabilidades familiares.</h3>
							<table>
            					<tr>
									<td>
						...
						<div id="seccion4" class="cardcuestionario">
							...
							<table>
            					<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="18" value="0" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="19" value="0" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="20" value="0" required >Siempre</label><br>
        						...
        						<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="21" value="0" required >Siempre</label><br>
						...
						<div id="seccion5" class="cardcuestionario">
							<h3 class="suntitulo">Las  preguntas  siguientes  están  relacionadas  con  la  capacitación  e  información  que  recibe  sobre  su trabajo.</h3>
							<table>
            					<tr>
									<td>
						...
						<div id="seccion6" class="cardcuestionario">
							<h3 class="suntitulo">Las preguntas siguientes se refieren a las relaciones con sus compañeros de trabajo y su jefe.</h3>
							<table>
            					<tr>
									<td>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="29" value="0" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="34" value="4" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="35" value="4" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="36" value="4" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="37" value="4" required >Siempre</label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="38" value="4" required >Siempre </label><br>
								...
								<tr>
									...
									<br>
										<div class="group">
											<label><input type="radio" name="39" value="4" required >Siempre</label><br>
						...
						<!-- TABLA DE BOTONES----------------------------------------------------------------------------------------------------------------INICIO DE TABLA BOTONES-->
						<table class="container row col-sm-12">
							<br>
            				<tr>
										<td class="col-sm-3 ">
						...
						<!-- FIN DE TABLA DE BOTONES---------------------------------------------------------------------------------------------------FIN DE TABLA BOTONES -->
