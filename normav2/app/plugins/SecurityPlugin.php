	...
	public function getAcl()
	{
		if (!isset($this->persistent->acl)) {
			...
			$publicResources = array(
				...
				'cuestionariouno'	=> array('formulario','guardar','revisarfolio'),
				'cuestionariodos'	=> array('formulario','guardar','revisarfolio'),
				'cuestionariotres'	=> array('formulario','guardar','revisarfolio'),
				'cuestionarioclima' =>array('formulario','guardar','revisarfolio'),
				'principal'		=> array('index','index2','cuestionariouno','validarcuestionario','gracias','gracias2'),
				'trabajador'	=> array('ajax_set_llenar_por_si_mismo_info'),
			...
			$usersResources = array(
				...
				'empresa'		=> array('ajax_empresa'),
				// 'ocupacion'		=> array('index','tabla','formulario','eliminar','ajax_ocupaciones'),
				'pais'			=> array('index','tabla'),
				'reporte'		=> array('index','formato','participantescursoexcel','avancecuestionario','consultaravancecuestionario','tablafolio','avancepordiacuestionario','consultaravancecuestionarioporfecha','tablafolioporfecha','respuestascuestionariouno','respuestascuestionariodos','respuestascuestionariotres','respuestascuestionariotresvista','manejadorconsultacuestionario3','respuestascuestionariodosvista','manejadorconsultacuestionario2'),
				...
				'session'    	=> array('end'),
				'trabajador'	=> array('buseditar','editar','crear','eliminar','ajax_set_llenar_por_si_mismo_info',"get_ajax_detalle"),
				...
				'cuestionario'	=> array('activarfolio','tablafolio','folionuevo','enviarcorreo','unsolofolionuevo','validarcorreo'),
				'cuestionariouno'	=> array('respuesta'),
				'cuestionariodos'	=> array('respuesta'),
				'cuestionariotres'	=> array('respuesta'),
				'cuestionarioclima'	=> array('respuesta','formato'),
				'configuracion' => array('cuestionarioactivacion','actualizarcuestionarioactivo','actualizarfechadecuestionarioactivo','fechacuestionario','anunciobienvenida','actualizaranuncio','anunciogracias1','anunciogracias2','logo','cambiarlogo',"anunciotextover"),
