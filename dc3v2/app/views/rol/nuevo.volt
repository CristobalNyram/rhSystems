          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                <div>
                  {{ form('rol/nuevo', 'id': 'rol_nuevo', 'class': 'captura form-horizontal form-label-left','data-parsley-validate') }}
                    ...
                    <div class="row ">
                      ...
                      <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                          ...
                          {{ form.render('rol_descripcion', ['class': 'form-control', 'placeholder':'Descripción del rol','onkeyup':'javascript:this.value=this.value.toUpperCase();']) }}
                        </div>
                      </div>
                    </div>
                    <div class="row">
