                                ...
                                <div class="card_validacion_2">
                                    <div id='resultado' class="">
                                        <div class='valido' style="padding-top: 5%;">
                                          {% if valido==1 %}
                                          <h2 id="consulta'+id+" class="mensaje">El documento DC3 es válido con la siguiente información</h2>
                                          <br>
                                            <h2><small>Trabajador</small> {{ tra_nombre }}<br></h2>
                                            <h2><small>Curso</small> {{ curso }}</h2>
                                            <h2><small>En el periodo</small> de {{ inicial }} a {{ final }}</h2>
                                            <h2><small>Expedido: </small>{{ expedicion }}</h2>
                                          {% endif %}

                                          {% if valido==0 %}
                                            <h2 id="consulta'+id+" class="mensaje_negativo">No se ha encontrado registro sobre el participante</h2>
