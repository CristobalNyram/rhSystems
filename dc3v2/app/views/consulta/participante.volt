               ...
               <div class="panel-body">
                 <div class="row"  style="margin:20px 0">
                   <div class="col-xs-6 col-xs-offset-3">
                    {% if valido==1 %}
                      <h3  style="color:green; font-family:verdana; font-size:200%; text-align:center;">La clave es válida con la siguiente información</h3>
                      <br>

                      <h1>Nombre del trabajador: {{ tra_nombre }}</h1>
                      
                      <h1>Curso recibido: {{ curso }}</h1>
                    ...
                    {% if valido==0 %}
                      <h4 style="color:red; font-family:verdana; font-size:200%;">No se ha encontrado registro sobre el participante</h4>
                    {% endif %}
