          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                <div>
                  {{ form('estado/editar/', 'id': 'estado_editar', 'class': 'captura form-horizontal form-label-left','data-parsley-validate') }}
                  <!-- <form id="demo-form2" data-parsley-validate class="captura form-horizontal form-label-left"> -->
                    ...
                    <div class="row ">
                      <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                          {{ form.label('est_id') }}
                          {{ form.render('est_id', ['class': 'form-control','required': 'true','placeholder':'ID del Estado','readonly': true]) }}
                        </div>
                      </div>
                      <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-xs-3 pull-right">
                          <a href="{{ url('estado/index') }}" id="href_cancelar" class="btn btn-block btn cancelar ">
