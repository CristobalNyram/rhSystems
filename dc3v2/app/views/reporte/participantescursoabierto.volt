...
<div class="row">
    <h1>Reporte general de cursos abiertos</h1>
    <div class="col-xs-12">
        {{ form('', 'id': 'index','data-parsley-validate') }}
            <div class="container">
                ...
                <button type="submit" class="btn btn-btnempresa" onclick=this.form.action="{{ url('reporte/participantescursoabierto') }}"><i class="fa fa-search"></i> Buscar</button>

                <button type="submit" class="btn btn-btnempresa" onclick=this.form.action="{{ url('reporte/participantescursoabiertoexcel') }}"><i class="fa fa-download"></i> Descargar</button>
