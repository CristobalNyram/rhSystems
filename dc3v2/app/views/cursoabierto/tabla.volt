...
{% for cuo in page %}
    {% if loop.first %}
		<div class="table-responsive" id="lista-agrupada" style="padding-right: 20px; padding-left: 20px;">
		    <table id="cursoabierto" class="table table-striped table-bordered" cellspacing="0"  align="center">
		        <thead>
		            <tr>
		                <th>Clave</th>
		                <th>Nombre</th>
		        ...
		        {% endif %}
		            <tr>
		                ...
		                <td width="7%">
		                	{% if editarcurso==1 %}
		                	{{ link_to("cursoabierto/formulario/"~cuo.cuo_id, '<i class="fa fa-pencil"></i>', "class": "btn","title":"Editar") }}
		                	{% endif %}
		                	<!-- {{ link_to("cursootorgado/formulario/"~cuo.cuo_id, '<i class="fa fa-pencil"></i>', "class": "btn","title":"Editar") }}
		                 	...
		                 	{{ link_to("cursoabierto/participantes/"~cuo.cuo_id, '<i class="fa fa-users"></i>', "class": "btn","title":"Participantes") }}
		                 	{% endif %}
		                 	{% if verparticipante==1 %}
