          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                <div>
                  {{ form('cursolinea/formulario/'~clave, 'id': 'registro', 'class': 'captura form-horizontal form-label-left','data-parsley-validate') }}
                      ...
                      {% for el in clases %}
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-xs-3 pull-right">
                              <a href="{{ url('cursolinea/index') }}" id="href_cancelar" class="btn btn-block btn cancelar ">
...
$('#cur_id').on('change', function() {
  ...
  curso=this.value;
  urlcurso="<?php echo $this->url->get('cursolinea/gethoras/') ?>";
