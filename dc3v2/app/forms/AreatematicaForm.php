...
class AreatematicaForm extends Form
{	
    /**
    ...
    public function NuevosCampos()
    {
        ...
        $nombre->setAttributes(array('maxlength' => 150, 'placeholder' => "Clave del área temática", "class"=>"form-control","onkeyup"=>"javascript:this.value=this.value.toUpperCase();"));
        ...
        $hora->setAttributes(array('maxlength' => 150, 'placeholder' => "Área de denominación", "class"=>"form-control","onkeyup"=>"javascript:this.value=this.value.toUpperCase();"));
    ...
    public function EditarCampos()
    {
        ...
        $nombre->setLabel("Clave del área temática");
        $nombre->setFilters(array('striptags', 'string'));
        $nombre->setAttributes(array('maxlength' => 150, 'placeholder' => "Clave del área","class"=>"form-control","onkeyup"=>"javascript:this.value=this.value.toUpperCase();"));
        $nombre->addValidators(array(
            new PresenceOf(array(
                'message' => 'Clave obligatoria'
            ))
